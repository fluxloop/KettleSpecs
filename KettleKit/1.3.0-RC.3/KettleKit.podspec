KETTLE_VERSION="1.3.0-RC.3"
KETTLE_SOURCE="https://kettleartifacts.blob.core.windows.net/ios/1.3.0-RC.3.zip"
...
Pod::Spec.new do |s|
    ...
    s.resource_bundle = { 'KettleResources' => "KettleKit/Resources/*" }
end